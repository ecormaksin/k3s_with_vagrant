...
# Powershellで指定する場合の例: $env:VAGRANT_PUBLIC_NETWORK_BRIDGE="Intel(R) Wireless-AC 9560";
# 永続的に環境変数を指定する場合: [System.Environment]::SetEnvironmentVariable('VAGRANT_PUBLIC_NETWORK_BRIDGE', 'Intel(R) Wireless-AC 9560', [System.EnvironmentVariableTarget]::User)
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "k3sserver" do |k3sserver|
    ...
    k3sserver.vm.provision "shell", inline: "curl -sfL https://get.k3s.io | sh -"
